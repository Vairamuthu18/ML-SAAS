        ...
        <div className="interface-grid">
          ...
          <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div style={{ fontFamily: 'monospace', fontSize: '0.75rem' }}>
              <p>[ ML VIZ LAB ]</p>
              <p>MASTER MACHINE LEARNING VISUALLY</p>
            </div>
            <a href="http://127.0.0.1:3000/app.html" className="cta-button">GET STARTED</a>
          </div>
        </div>

        <div className="viewport">
          <div className="canvas-3d" ref={canvasRef}>
            <div className="layer layer-1" ref={(el) => { layersRef.current[0] = el as HTMLDivElement; }}></div>
            <div className="layer layer-2" ref={(el) => { layersRef.current[1] = el as HTMLDivElement; }}></div>
            <div className="layer layer-3" ref={(el) => { layersRef.current[2] = el as HTMLDivElement; }}></div>
