    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <nav className="relative z-10 flex flex-row items-center justify-between px-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Modules</a>
          <a href="#" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Playground</a>
        </div>
        <a href="/app.html" className="liquid-glass rounded-full px-6 py-2.5 text-sm text-foreground hover:scale-[1.03] transition-transform cursor-pointer text-center">
          Start Learning
        </a>
      </nav>
